...
<c:forEach var="p" items="${list1}" begin="0" end="11">
	<div class="col-sm-3" style="padding: 5px 5px 5px 5px">
		<div class="thumbnail" style="border-radius: 7px;">
			...
			<a href="/product/detail/${p.id}" >
				...
				<img style="margin-right: 30px;margin-top: 5px; border-radius: 7px;" class="estore-prod" src="/static/images/products/${p.image}" title="${p.name}">
			</a>

			<div class="caption" >
				<p style="padding: 3px; text-align: center; color: black; font-size: 18px;">
					<b>${p.name}</b>
				</p>
				<p
					style="padding: 3px; font-size: 22px; text-align: center; font-weight: bold;">
					<c:choose>
						<c:when test="${p.discount <= 0 }">
