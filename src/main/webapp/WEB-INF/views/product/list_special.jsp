	...
	<div id="carousel-example" class="carousel slide hidden-xs"
		...
		<div class="carousel-inner">
			...
			<div class="item active"  >
				<div class="row">
					<div style="width: 50px;margin-left: 10px;padding-left: 15px">
						<a style="font-size: 20px; margin-top: 180px"
					...
					<c:forEach var="p" items="${list}" begin="0" end="3">
						<div class="col" style="padding: 5px 5px 5px 5px">
							<div class="thumbnail" style="border-radius: 7px;">
								...
								<div class="caption">
									<p style="padding: 3px; text-align: center; color: black; font-size: 15px;">
										<b>${p.name}</b>
									</p>
									<p
										style="padding: 2px; font-size: 19px; text-align: center; font-weight: bold;">
										<c:choose>
											<c:when test="${p.discount <= 0 }">
												<span
								...
								<div class="caption">
									...
									<p
										...
										<c:choose>
											<c:when test="${p.discount <= 0 }">
												<span
													style="text-align: left; font-weight: bold; color: red; font-size: 19px;"><f:formatNumber
														value="${p.unitPrice}" pattern="#,###" />₫ </span>
											</c:when>
											<c:otherwise>
												<span
