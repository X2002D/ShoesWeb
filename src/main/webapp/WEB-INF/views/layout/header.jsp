	...
	<div class="container ">
		<div class="row" style="padding: 20px 15px 12px;">
			<div class="col-sm-4" style="margin-top: -15px; padding-left: 0px;">
				<a href="/"><img src="/static/images/sneakers1.jpg" alt="" width="270px"></a>
			</div>
			<div class="col-sm-4" style="padding-right: 10px;">
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						<input style="width: 250px; border-radius: 0 10 10 0px;" class="form-control" value="${param.keywords}" name="keywords" placeholder="Tìm kiếm" />
						<div class="input-group-append">
							<button class="btn btn-secondary" value="${param.keywords}" type="submit" style="background-color: #CE1212; border: none; width: 50px; height: 34px; border-radius: 0 5px 5px 0;">
			...
			<div class="col-sm-4" style="padding: 0px 35px;">
				<div class="row">
									...
									<ul>
										<li>
											...
											<div class="tong-tien">
												...
												<br />
												<div>
													<a style="width: 295px" class="btn btn-danger"
					...
					<div class="col-sm-6">
						<div class="header-menu">
							<i class="fa fa-thumbs-up" style="font-size: 30px; padding: 0px 5px 0px 5x"></i> 
								<a class="splike" href="/product/favo" style="color: #474c51"> Sản phẩm yêu thích</a>
						</div>
					</div>
				</div>
			</div>
